...
class HostAPITests(APITestCase):
    ...
    def test_host_update_counts(self):
        ...
        self.assertIn('provider_instance_id', response.data)
        self.assertIn('provider_vm_name', response.data)
        self.assertIn('provider_region', response.data)
        self.assertIn('provider_zone', response.data)
        self.assertIn('provider_account_scope', response.data)
        self.assertIn('provider_resource_group', response.data)
        self.assertIn('provider_machine_id', response.data)
        self.assertIn('last_provider_power_state', response.data)
        self.assertIn('last_provider_sync_at', response.data)
        self.assertIn('reconcile_confidence', response.data)
        self.assertIn('reconcile_reason', response.data)
        ...
        self.assertIsNone(response.data['provider_name'])
        self.assertIsNone(response.data['provider_instance_id'])
        self.assertIsNone(response.data['provider_vm_name'])
        self.assertIsNone(response.data['provider_region'])
        self.assertIsNone(response.data['provider_zone'])
        self.assertIsNone(response.data['provider_account_scope'])
        self.assertIsNone(response.data['provider_resource_group'])
        self.assertIsNone(response.data['provider_machine_id'])
        self.assertIsNone(response.data['last_provider_power_state'])
        self.assertIsNone(response.data['last_provider_sync_at'])
        self.assertEqual(response.data['reconcile_confidence'], 'unknown')
        self.assertIsNone(response.data['reconcile_reason'])
